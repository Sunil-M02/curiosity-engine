...
const Index = () => {
  const jsonLd = {
    ...
    "description": "A knowledge-first digital publication exploring science, technology, AI, history, astronomy, and future innovation.",
  ...
  const organizationJsonLd = {
    ...
    "sameAs": [
      "https://twitter.com/curiosityfields",
      "https://linkedin.com/company/curiosityfields"
    ]
  };
  ...
  return (
    <Layout>
      <SEO
        ...
        canonical="https://curiosityfields.com"
      />
