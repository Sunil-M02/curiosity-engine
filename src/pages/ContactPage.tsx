...
const ContactPage = () => {
  ...
  return (
    <Layout>
      <SEO title="Contact Us" description="Get in touch with the CuriosityFields editorial team — pitch a story, ask a question, or share a partnership idea." canonical="https://www.curiosityfields.com/contact" />
