    ...
    <Layout>
      ...
      <div className="container content-rail py-12 lg:py-20">
        ...
        <motion.div
          ...
          className="max-w-3xl article-content"
        >
          ...
          <p>
            All content on CuriosityFields is for informational purposes only. You may not reproduce, distribute, or
            create derivative works without permission.
          </p>

          <h2>3. User Conduct</h2>
          <p>
            You agree to use our services responsibly and not engage in any activity that could harm the platform or
            other users.
          </p>
          ...
          <p>
            CuriosityFields is provided "as is" without warranties. We are not liable for any damages arising from your
            use of our services.
          </p>

          <h2>6. Contact</h2>
          <p>For questions about these terms, contact us at sunilfun009@gmail.com.</p>
        </motion.div>
      </div>
    </Layout>
  );
